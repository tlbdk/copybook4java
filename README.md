...
**Project have been migrated to [https://github.com/NordeaOSS/copybook4java](https://github.com/NordeaOSS/copybook4java) and this version will not be maintained moving forward**
